...
export function RealNuevaVentaTest() {
  ...
  useEffect(() => {
    const subscription = form.watch((value, { name }) => {
      if (name === 'fecha_venta') {
        ...
        const logEntry = `[${timestamp}] RealNuevaVentaTest - fecha_venta cambió: ${value.fecha_venta} (tipo: ${typeof value.fecha_venta})`
        
        console.log("RealNuevaVentaTest - fecha_venta cambió:", value.fecha_venta)
        console.log("RealNuevaVentaTest - Tipo de fecha:", typeof value.fecha_venta)
  ...
  const onSubmit = (values: any) => {
    console.log("RealNuevaVentaTest - onSubmit:", values)
    console.log("RealNuevaVentaTest - fecha_venta:", values.fecha_venta)
    console.log("RealNuevaVentaTest - Tipo de fecha:", typeof values.fecha_venta)
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Prueba - Formulario Real de Nueva Venta</CardTitle>
        </CardHeader>
